...
export default function NavigationAndAddress() {
  ...
  return (
    <motion.div
      ...
      className="bg-white px-6 flex flex-col items-center text-center text-black w-full"
    >
      ...
      <motion.div variants={sectionVariants} className="text-center">
        ...
        <motion.h2 variants={sectionVariants} className="text-base">
      ...
      <motion.div
        ...
        className="w-full mt-6 rounded-xl overflow-hidden shadow-lg border"
      >
        <Map
      ...
      <motion.div variants={buttonsVariants} className="grid grid-cols-3 gap-4 mt-6 w-full">
        <motion.button
      ...
      <motion.div
        ...
        className="w-full mt-10 text-left text-sm border-t pt-6 space-y-6"
      >
        <motion.div
          variants={infoItemVariants}
          className="bg-[#fff9f9] p-4 rounded-lg border-l-4 border-[#ee7685]"
        >
        ...
        <motion.div variants={infoItemVariants} className="pb-4">
